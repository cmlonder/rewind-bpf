...
| Network policy | **Partial** | Loopback HTTP/HTTPS proxy backend with allow/audit/deny decisions for proxy-aware clients | Network namespace/cgroup egress enforcement and raw-socket coverage |
