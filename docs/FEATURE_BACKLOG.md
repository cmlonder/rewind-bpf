...
| Signed policy provenance | **Shipped / local trust** | Ed25519 keygen/sign/verify policy bundles, signer key IDs, and optional supervisor public-key allow-list enforcement | Remote registry, revocation, and organization trust distribution |
