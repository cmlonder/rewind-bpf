...
| Explicit acceptance | **Shipped / Linux** | Review-only JSON export plus text-file unified patch export and manifest conflict checks; `rewind commit --confirm`; supervisor commit requires confirmation | Branch adapters, directory/mode-aware patch packaging, and remote review workflow |
