...
| Control Plane UI | **Shipped / fixture + read-only bridge** | Responsive operational views, policy/config/workspace management fixtures, evidence/benchmark/audit views, supervisor read adapter | Connected browser mutation bridge with local action-token UX |
