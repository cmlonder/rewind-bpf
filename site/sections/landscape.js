...
export function Landscape() {
  return `<section class="landscape-section section-shell" id="landscape" aria-labelledby="landscape-title">
    ...
    <div class="landscape-note reveal"><span class="note-icon">!</span><p><strong>Benchmark honesty:</strong> nono is the closest product comparison. Tetragon and KubeArmor are kernel-policy neighbors; AgentFS is a filesystem/history alternative; DeltaBox is a research reference. None is silently installed in the VM, so external numbers stay <em>not-comparable</em> until their exact environment can be reproduced.</p><a href="https://github.com/rewindbpf/rewind/blob/main/benchmarks/COMPETITOR_MATRIX.md" target="_blank" rel="noreferrer">See provenance ledger ↗</a></div>
  </section>`;
}
