...
export function Roadmap() {
  return `<section class="roadmap-section section-shell" id="roadmap" aria-labelledby="roadmap-title">
    ...
    <div class="roadmap-foot reveal"><span>Next proof point</span><strong>Native platform gates + operational refresh tests</strong><span class="roadmap-line"></span><a href="https://github.com/rewindbpf/rewind/blob/main/docs/FEATURE_BACKLOG.md" target="_blank" rel="noreferrer">Read feature backlog ↗</a></div>
  </section>`;
}
