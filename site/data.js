export const siteData = {
  ...
  roadmap: [
    ...
    { phase: "P4", title: "P4: durable history + supervisor", status: "Control plane shipped", body: "Atomic bounded run history, token-authenticated supervisor transport, lifecycle actions, event snapshots, and a fixture-backed retention view are now in place." },
  ],
  delivered: [
