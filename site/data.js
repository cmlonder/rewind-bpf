export const siteData = {
  ...
  roadmap: [
    ...
    { phase: "P1", title: "P1: Linux productisation", status: "Partial", body: "The proxy backend, raw/packet socket refusal in enforce mode, refusing credential boundary, conflict-checked commit, authenticated supervisor, signed policy import, trusted signer allow-lists, and reconnecting browser event stream are shipped. Network namespaces, a real credential provider, and patch/branch adapters remain." },
