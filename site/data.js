export const siteData = {
  ...
  roadmap: [
    ...
    { phase: "P1", title: "P1: Linux productisation", status: "Partial", body: "The proxy and fail-closed deny backends, raw/packet socket refusal plus socket-deny evidence, opt-in short-lived external-command credential leases, conflict-checked commit, authenticated supervisor, signed policy import, trusted signer allow-lists, reconnecting browser event stream, text/full-fidelity patch exports, checksummed release metadata with local Ed25519 signing, clean-branch Git acceptance, and signed evidence hand-off are shipped. Allow-listed network namespaces, native secret-manager adapters, public trust rotation, and remote review/object storage remain." },
