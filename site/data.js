export const siteData = {
  ...
  roadmap: [
    { phase: "NOW", title: "P0: safe transaction core", status: "Complete · UTM gate passed", tags: ["PROCESS SCOPE", "START GATE", "READ POLICY", "COW ROLLBACK", "CRASH RECOVERY", "EVIDENCE", "DIFF + EXPORT", "BENCHMARKS", "NAMESPACE EGRESS", "JURY DEMO"], body: "Validated end-to-end in a disposable Ubuntu VM. The transaction, evidence, recovery, and jury demo paths are reproducible." },
    { phase: "P1", title: "P1: Linux productisation", status: "Complete", tags: ["PROXY + DENY", "NAMESPACE / NAT", "CREDENTIAL LEASES", "REMOTE EVIDENCE", "SUPERVISOR", "RELEASE SIGNING"], body: "The Linux control plane and evidence hand-off are shipped. KMS/provider IAM, per-agent profiles, and distributed sessions remain deployment work." },
    { phase: "P2", title: "P2: native macOS adapter", status: "Lifecycle + crash smoke shipped", tags: ["APFS CLONE", "SEATBELT", "READ HIDING", "REVIEW / COMMIT", "SIGKILL RECOVERY"], body: "The staged macOS lifecycle is shipped and covered by disposable-fixture tests. EndpointSecurity telemetry, network/resource enforcement, signed helper entitlement, and power-loss acceptance remain gates." },
    { phase: "P3", title: "P3: native Windows adapter", status: "Code complete / manual gate", tags: ["CROSS-BUILD", "JOB OBJECT", "FAIL CLOSED", "HELPER VERIFY"], body: "The native contract and process lifecycle are ready. A signed minifilter, restricted-token launch, disposable VHDX workspace, and Windows VM acceptance remain before host enforcement." },
    { phase: "P4", title: "P4: scale + ecosystem", status: "Partial", tags: ["HISTORY", "RECONNECT", "POLICY PROVENANCE", "REMOTE RESTORE", "PII", "CHECKPOINTS", "ACTION TOKENS"], body: "The local control plane, trusted registry flow, leases, evidence hand-off, and checkpoint foundation are shipped. SDK adapters, registry durability/KMS, streaming PII coverage, and live multi-agent orchestration remain." },
  ],
  delivered: [
