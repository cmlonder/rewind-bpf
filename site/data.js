export const siteData = {
  ...
  capabilities: [
    ...
    },
    {
      ...
      tag: "SHIPPED",
      body: "Inspect a merged-view diff and export a non-mutating JSON review bundle or text-file unified patch with before/after manifests and created, modified, deleted, or renamed paths.",
      detail: "A live workspace is never overwritten by the export command. JSON remains canonical for directories, symlinks, modes, and binary files; `rewind commit --confirm` applies only after the destination manifest passes the conflict gate.",
      tone: "lavender",
    },
    {
      number: "06",
