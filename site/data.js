export const siteData = {
  ...
  roadmap: [
    ...
    { phase: "P4", title: "P4: scale + ecosystem", status: "Partial", body: "Local history, authenticated supervisor, follow streams with reconnect, signed policy provenance, encrypted hand-off, detachable sessions, agent adapter identity, and deterministic PII audit are shipped. SDK-specific adapters, remote registry/retention, runtime PII enforcement, and multi-agent checkpoints remain." },
  ],
  delivered: [
